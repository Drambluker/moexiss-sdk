...
public class EngineResponse extends BasicEntity<EngineResponse.Fields>
{
    ...
    {
        return integerFields.get(Fields.ID);
    }
    ...
    /**
     * Возвращает значение поля {@code ShortTitle}.
     *
     * @return значение поля или {@code null}, если оно отсутствует в ответе
     */
    public String getShortTitle()
    {
        return stringFields.get(Fields.SHORT_TITLE);
    }
    ...
    public static final class Processor extends AbstractProcessor<EngineResponse, Fields>
    {
        @Override
