...
class MoexClientTest
{
    ...
    void usesConfiguredBaseUrlAndDeserializesResponse() throws IOException
    {
        ...
        assertEquals(1, engines.getFirst().getId());
        assertEquals("stock", engines.getFirst().getName());
        assertEquals("Stock", engines.getFirst()
                .get(EngineResponse.Fields.SHORT_TITLE, String.class));
        assertTrue(engines.getFirst().has(EngineResponse.Fields.TITLE));
        assertThrows(IllegalArgumentException.class,
                () -> engines.getFirst().get(EngineResponse.Fields.ID, String.class));
    }
    ...
    void rejectsInvalidConfiguration()
    {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new MoexClient("fixture.test", url -> ""));
        assertThrows(IllegalArgumentException.class,
                () -> new MoexClient("ftp://fixture.test", url -> ""));
        assertThrows(IllegalArgumentException.class,
                () -> new MoexClient("https://user:secret@fixture.test", url -> ""));
        assertThrows(IllegalArgumentException.class,
                () -> new MoexClient("https://fixture.test?token=secret", url -> ""));
        assertThrows(IllegalArgumentException.class,
                () -> new MoexClient("https://fixture.test#fragment", url -> ""));
