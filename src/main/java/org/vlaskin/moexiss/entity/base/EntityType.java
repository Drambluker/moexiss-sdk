...
@Slf4j
@InternalApi
public record EntityType<T extends BasicEntity<E>, E extends Enum<?> & TypedField>(AbstractProcessor<T, E> processor)
{
    ...
    public static final EntityType<TableFieldResponse, TableFieldResponse.Fields> SECURITY_FIELD =
            new EntityType<>(new TableFieldResponse.Processor());
    public static final EntityType<TableFieldResponse, TableFieldResponse.Fields> MARKET_DATA_FIELD =
            new EntityType<>(new TableFieldResponse.Processor());
    public static final EntityType<TableFieldResponse, TableFieldResponse.Fields> TRADE_FIELD =
            new EntityType<>(new TableFieldResponse.Processor());
    public static final EntityType<TableFieldResponse, TableFieldResponse.Fields> ORDER_BOOK_FIELD =
            new EntityType<>(new TableFieldResponse.Processor());
    public static final EntityType<TableFieldResponse, TableFieldResponse.Fields> HISTORY_FIELD =
            new EntityType<>(new TableFieldResponse.Processor());
    public static final EntityType<TableFieldResponse, TableFieldResponse.Fields> TRADE_HISTORY_FIELD =
            new EntityType<>(new TableFieldResponse.Processor());
    public static final EntityType<TableFieldResponse, TableFieldResponse.Fields> MARKET_DATA_YIELD_FIELD =
            new EntityType<>(new TableFieldResponse.Processor());
    public static final EntityType<TableFieldResponse, TableFieldResponse.Fields> TRADE_YIELD_FIELD =
            new EntityType<>(new TableFieldResponse.Processor());
    public static final EntityType<TableFieldResponse, TableFieldResponse.Fields> HISTORY_YIELD_FIELD =
            new EntityType<>(new TableFieldResponse.Processor());
    public static final EntityType<TableFieldResponse, TableFieldResponse.Fields> SECURITY_STATISTIC_FIELD =
            new EntityType<>(new TableFieldResponse.Processor());
    ...
    public static final EntityType<DurationResponse, DurationResponse.Fields> DURATION = new EntityType<>(new DurationResponse.Processor());
    public static final EntityType<SecurityTypeResponse, SecurityTypeResponse.Fields> SECURITY_TYPE = new EntityType<>(new SecurityTypeResponse.Processor());
    public static final EntityType<SecurityGroupResponse, SecurityGroupResponse.Fields> SECURITY_GROUP = new EntityType<>(new SecurityGroupResponse.Processor());
    public static final EntityType<SecurityCollectionResponse, SecurityCollectionResponse.Fields> SECURITY_COLLECTION = new EntityType<>(new SecurityCollectionResponse.Processor());
    ...
    static
    {
        ...
        REGISTRY.get(Response.class).put("durations", DURATION);
        REGISTRY.get(Response.class).put("securitytypes", SECURITY_TYPE);
        REGISTRY.get(Response.class).put("securitygroups", SECURITY_GROUP);
        REGISTRY.get(Response.class).put("securitycollections", SECURITY_COLLECTION);
