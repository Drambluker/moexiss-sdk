...
import org.vlaskin.moexiss.entity.IndexAnalytics;
...
import org.vlaskin.moexiss.entity.TickerInfo;
...
public class StatisticService extends BaseService
{
     ...
     */
    public List<Index> getIndices(IndicesStatisticParams params) throws IOException
    {
     ...
     */
    public IndexAnalytics getIndexAnalytics(AnalyticsStatisticParams params) throws IOException
    {
        Response response = getIndexAnalyticsResponse(params);
        return IndexAnalytics.builder()
     ...
     */
    public List<IndexAnalyticsData> getIndexAnalyticsData(AnalyticsStatisticParams params) throws IOException
    {
    ...
    public List<Cursor> getIndexAnalyticsCursor(AnalyticsStatisticParams params) throws IOException
    {
     ...
     */
    public List<IndexAnalyticsDates> getIndexAnalyticsDates(AnalyticsStatisticParams params) throws IOException
    {
    ...
    private Response getIndexAnalyticsResponse(AnalyticsStatisticParams params, String... only) throws IOException
    {
        ...
        if (params.getLanguage() != null)
            requestBuilder.append("&lang=").append(params.getLanguage());
        if (params.getPageIndex() != null && params.getLimit() != null)
     ...
     */
    public List<Ticker> getTickers(TickersStatisticParams params) throws IOException
    {
        Validate.notBlank(params.getIndex());
     ...
     */
    public TickerInfo getTickerInfo(TickerInfoStatisticParams params) throws IOException
    {
    ...
    public List<Ticker> getTickerInfoData(TickerInfoStatisticParams params) throws IOException
    {
        Response response = getTickerInfoResponse(params, "ticker");
        return ResponseUtils.convertTo(EntityType.TICKER, response);
    }

    public List<Cursor> getTickerInfoCursor(TickerInfoStatisticParams params) throws IOException
    {
