...
public class EngineService extends BaseService
{
     ...
     * Общие атрибуты ТС
     */
    public EngineResponse getEngineInfo(InfoEngineParams params) throws IOException
    {
     ...
     */
    public BoardResponse getBoard(BoardEngineParams params) throws IOException
    {
        Validate.notBlank(params.getEngine());
        Validate.notBlank(params.getMarket());
     ...
     * Справочник полей таблицы со статическими данными торговой сессии рынка
     */
    public SecurityResponse getBoardSecurity(BoardSecurityTableEngineParams params) throws IOException
    {
