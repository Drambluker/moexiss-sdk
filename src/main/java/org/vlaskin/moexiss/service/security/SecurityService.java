...
import org.vlaskin.moexiss.entity.SecurityInfo;
...
public class SecurityService extends BaseService
{
     ...
     */
    public List<Security> getList(ListSecurityParams params) throws IOException
    {
     ...
     */
    public SecurityInfo getInfo(InfoSecurityParams params) throws IOException
    {
     ...
     */
    public List<Description> getDescriptionsInfo(InfoSecurityParams params) throws IOException
    {
     ...
     */
    public List<Board> getBoardsInfo(InfoSecurityParams params) throws IOException
    {
     ...
     */
    public List<Index> getIndices(IndicesSecurityParams params) throws IOException
    {
        Validate.notBlank(params.getSecurity());
