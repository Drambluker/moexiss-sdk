...
/**
 * Группа инструментов из справочника MOEX ISS.
 */

@ToString(callSuper = true)
public class SecurityGroupResponse extends BasicEntity<SecurityGroupResponse.Fields>
{
    private SecurityGroupResponse()
    {
        super();
    }

    private SecurityGroupResponse(Map<Fields, Boolean> booleanFields,
    ...
    public static final class Processor extends AbstractProcessor<SecurityGroupResponse, Fields>
    {
        @Override
        public SecurityGroupResponse processJsonElement(JsonElement jsonElement, JsonArray columns,
                                                        JsonObject metadata)
        {
            SecurityGroupResponse entity = new SecurityGroupResponse();
