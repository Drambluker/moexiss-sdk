...
public final class MoexClient
{
     ...
     * @throws IllegalArgumentException если адрес не является абсолютным HTTP(S) URI либо
     * содержит пользовательские данные, query-параметры или фрагмент
     */
     ...
     * @throws NullPointerException если транспорт не задан
     * @throws IllegalArgumentException если адрес не является абсолютным HTTP(S) URI либо
     * содержит пользовательские данные, query-параметры или фрагмент
     */
