...
public class CursorResponse extends BasicEntity<CursorResponse.Fields>
{
    ...
    /**
     * Возвращает значение поля {@code Index}.
     *
     * @return значение поля или {@code null}, если оно отсутствует в ответе
     */
    public Long getIndex()
    {
        return longFields.get(Fields.INDEX);
    }

    /**
     * Возвращает значение поля {@code PageSize}.
     *
     * @return значение поля или {@code null}, если оно отсутствует в ответе
     */
    public Long getPageSize()
    {
        return longFields.get(Fields.PAGE_SIZE);
    }

    /**
     * Возвращает значение поля {@code Total}.
     *
     * @return значение поля или {@code null}, если оно отсутствует в ответе
     */
    public Long getTotal()
    {
        return longFields.get(Fields.TOTAL);
    }
    ...
    public static final class Processor extends AbstractProcessor<CursorResponse, Fields>
    {
        @Override
